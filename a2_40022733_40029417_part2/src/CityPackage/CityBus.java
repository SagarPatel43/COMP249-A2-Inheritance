...
public class CityBus extends PublicTransportation {
    ...
    public CityBus(CityBus copy) {
        ...
        this.routeNumber = copy.routeNumber;
        this.beginOpYear = copy.beginOpYear;
        this.lineName = copy.lineName;
        this.driverName = copy.driverName;
    }
    ...
    public boolean equals(CityBus ob) {
        ...
        if (routeNumber == c.routeNumber && beginOpYear == c.beginOpYear && lineName.equals(c.lineName) && driverName.equals(c.driverName) && super.getPrice() == c.getPrice()
